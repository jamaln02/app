...
import { ArrowRight, ArrowLeft, Gift, CheckCircle2, Copy, Check } from 'lucide-react';
  ...
  const questions = [
    {
      ...
      fields: [
        ...
        { name: 'age', label: 'العمر', type: 'number', required: true, placeholder: '25' },
        { name: 'location', label: 'المنطقة/المدينة', type: 'text', required: true, placeholder: 'دمشق، حلب، اللاذقية...' }
      ]
    },
    {
      id: 'gender',
    ...
    },
    {
      id: 'favorites',
      title: 'عطورك المفضلة',
      subtitle: 'شو العطور يلي بتحبها أو بتستخدمها حالياً؟',
      fields: [
        { name: 'favoritePerfumes', label: 'العطور المفضلة', type: 'textarea', required: true, placeholder: 'مثلاً: Dior Sauvage, Chanel No 5, أو أي عطر بتحبو...' }
      ]
    },
    {
      id: 'frequency',
    ...
    {
      id: 'type',
      title: 'نوع العطر المفضل',
      subtitle: 'شو بتفضل أكتر؟',
      type: 'radio',
      name: 'perfumeType',
      options: [
    ...
    },
    {
      ...
      options: [
        ...
        { value: 'friends', label: 'أصدقاء وعائلة' },
        { value: 'store', label: 'زيارة المحلات' },
        { value: 'influencers', label: 'مؤثرين ومشاهير' },
    ...
    },
    {
      ...
      fields: [
        { name: 'wishList', label: 'وصف العطر المثالي', type: 'textarea', required: true, placeholder: 'احكيلنا عن العطر يلي بتحلم فيه... الرائحة، الثبات، التصميم...' }
      ]
    }
  ];
      ...
      for (let field of question.fields) {
        ...
        if (field.name === 'phone' && formData[field.name]) {
          ...
          if (!phoneRegex.test(formData[field.name].replace(/\s/g, ''))) {
            setError('الرجاء إدخال رقم موبايل صحيح');
            return false;
          }
        }
      }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setCurrentStep(questions.length); // Show success page
      } else {
        setError(response.data.message || 'حدث خطأ، الرجاء المحاولة مرة أخرى');
      }
    } catch (err) {
        ...
        <div className="max-w-2xl w-full">
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 md:p-12 text-center border-2 border-[#bb8d4f]/20">
            <div className="mb-6">
              ...
              <h1 className="text-4xl font-bold text-[#2b0c10] mb-3 font-cairo">
                مبروك! 🎉
              </h1>
              <p className="text-xl text-[#2b0c10]/80 font-cairo">
                شكراً لمشاركتك! حصلت على خصم حصري
              </p>
            </div>
            ...
            <Button
              ...
              className="w-full bg-white text-[#2b0c10] hover:bg-[#efcfa6] font-cairo font-bold text-lg py-6 rounded-xl transition-all duration-300 mb-4"
            >
              {copied ? (
                <>
            ...
            <div className="bg-[#bb8d4f]/10 rounded-xl p-4 mb-6">
              <p className="text-[#2b0c10]/70 text-sm font-cairo leading-relaxed">
                📸 <strong>مهم:</strong> خذ سكرين شوت لهذه الصفحة أو انسخ الكود الآن!<br/>
                سنتواصل معك قريباً على الواتساب للتأكيد
              </p>
            </div>
            ...
            <Button
              onClick={() => navigate('/')}
              variant="outline"
              className="border-[#2b0c10] text-[#2b0c10] hover:bg-[#2b0c10] hover:text-white font-cairo"
            >
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="h-2 bg-white/50 rounded-full overflow-hidden">
            <div 
              className="h-full bg-gradient-to-r from-[#2b0c10] to-[#bb8d4f] transition-all duration-500 ease-out"
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-6 md:p-8 border-2 border-[#bb8d4f]/20">
          ...
          {currentQuestion.type === 'radio' && (
            <RadioGroup
              ...
              onValueChange={(value) => handleRadioChange(currentQuestion.name, value)}
              className="space-y-3"
            >
              {currentQuestion.options.map((option) => (
                ...
                >
                  ...
                  <Label htmlFor={option.value} className="flex-1 cursor-pointer font-cairo text-lg">
                    {option.label}
                  </Label>
                </div>
              ))}
                ...
                <div key={field.name}>
                  ...
                  {field.type === 'textarea' ? (
                    <Textarea
                      ...
                      className="min-h-[120px] font-cairo border-[#bb8d4f]/30 focus:border-[#bb8d4f]"
                      dir="rtl"
                    />
                  ) : (
                    <Input
                      ...
                      onChange={handleInputChange}
                      placeholder={field.placeholder}
                      className="font-cairo border-[#bb8d4f]/30 focus:border-[#bb8d4f]"
          ...
          <div className="flex gap-3 mt-6">
            {currentStep > 0 && (
              <Button
                onClick={handleBack}
                variant="outline"
                className="flex-1 border-[#2b0c10] text-[#2b0c10] hover:bg-[#2b0c10] hover:text-white font-cairo py-6 text-lg"
                disabled={loading}
              >
            ...
            <Button
              onClick={handleNext}
              className="flex-1 bg-gradient-to-r from-[#2b0c10] to-[#bb8d4f] text-white hover:from-[#bb8d4f] hover:to-[#d4a574] font-cairo py-6 text-lg"
              disabled={loading}
            >
              {loading ? (
                'جاري الحفظ...'
        ...
        <div className="text-center mt-6">
          <Button
            onClick={() => navigate('/')}
            variant="ghost"
            className="text-[#2b0c10]/60 hover:text-[#2b0c10] font-cairo"
          >
            العودة للصفحة الرئيسية
          </Button>
        </div>
